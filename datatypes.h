...
#ifndef Komodo_API_TYPES_H
#define Komodo_API_TYPES_H
...
//ret.notarizedtxid_height = result["noatizedtxid_heigh"].asInt();
//ret.notarized_confirms = result["notarized_confirms"].asInt();
    ...
    struct getinfo_t{
        ...
        int notarizedtxid_height;
        int notarized_confirms;
        double balance;
        int KMDversion;
        int blocks;
        int timeoffset;
