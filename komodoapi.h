...
public:
    /*Const and Dest*/
    KomodoAPI(const std::string& user, const std::string& password, const std::string& host, int port);
    ~KomodoAPI();
    ...
    /*Wallet functions - @Rick please wrte wrapper for walletbackup (GUI)*/
    ...
    std::string dumpprivkey(const std::string& Komodoaddress);
    void importprivkey(const std::string& Komodoprivkey);
    void importprivkey(const std::string& Komodoprivkey, const std::string& label, bool rescan = true);
    ...
    validateaddress_t validateaddress(const std::string& Komodoaddress);

    void keypoolrefill();
    bool settxfee(double amount);

    std::string signmessage(const std::string& Komodoaddress, const std::string& message);
    bool verifymessage(const std::string& Komodoaddress, const std::string& signature, const std::string& message);

    getinfo_t getinfo();
    void stop();


    /*Accounting @RICK add wrapper to get numeral values in string and text represnts */
    double getbalance();
    ...
    double getreceivedbyaddress(const std::string& Komodoaddress, int minconf = 1);
    ...
    std::string getaccount(const std::string& Komodoaddress);
    ...
    void setaccount(const std::string& Komodoaddress, const std::string& account);

    std::string sendtoaddress(const std::string& Komodoaddress, double amount);
    std::string sendtoaddress(const std::string& Komodoaddress, double amount, const std::string& comment, const std::string& comment_to);

    std::string sendfrom(const std::string& fromaccount, const std::string& toKomodoaddress, double amount);
    std::string sendfrom(const std::string& fromaccount, const std::string& toKomodoaddress, double amount, const std::string& comment, const std::string& comment_to, int minconf = 1);
    ...
    /* Mining functions - todo @RICK @jinhaow - extend the functionalities for assetchain related things*/
    ...
    /* Low level calls - for the nerds out there @RICK please TEST ALL functs*/
